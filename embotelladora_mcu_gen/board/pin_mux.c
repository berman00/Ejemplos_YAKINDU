...
- {pin_num: '28', pin_signal: PTA12/TPM1_CH0/I2S0_TXD0, label: 'J1[8]/D3'}
- {pin_num: '26', pin_signal: PTA4/I2C1_SDA/TPM0_CH1/NMI_b, label: 'J1[10]/D4/SW1', identifier: SW1}
- {pin_num: '27', pin_signal: PTA5/USB_CLKIN/TPM0_CH2/I2S0_TX_BCLK, label: 'J1[12]/D5/I2S_TX_BCLK', identifier: I2S0_TX_BCLK}
...
- {pin_num: '29', pin_signal: PTA13/TPM1_CH1/I2S0_TX_FS, label: 'J2[2]/D8'}
...
- {pin_num: '2', pin_signal: LCD_P49/PTE1/SPI1_MOSI/LPUART1_RX/SPI1_MISO/I2C1_SCL, label: 'J2[12]/D15/I2C1_SCL/LCD_P49', identifier: I2C1_SCL}
...
- {pin_num: '54', pin_signal: LCD_P25/PTC5/LLWU_P9/SPI0_SCK/LPTMR0_ALT2/I2S0_RXD0/CMP0_OUT, label: 'J1[15]/I2S_RXD/INT1_ACCEL/LCD_P25', identifier: INT1_ACCEL;I2S0_RXD0}
- {pin_num: '56', pin_signal: LCD_P27/CMP0_IN1/PTC7/SPI0_MISO/USB_SOF_OUT/I2S0_RX_FS/SPI0_MOSI, label: 'J1[11]/I2S_RX_FS/USB_SOF_OUT/LCD_P27', identifier: LCD_P27;I2S0_RX_FS}
- {pin_num: '55', pin_signal: LCD_P26/CMP0_IN0/PTC6/LLWU_P10/SPI0_MOSI/EXTRG_IN/I2S0_RX_BCLK/SPI0_MISO/I2S0_MCLK, label: 'J1[9]/I2S_RX_BCLK/LCD_P26', identifier: LCD_P26;I2S0_RX_BCLK}
- {pin_num: '53', pin_signal: LCD_P24/PTC4/LLWU_P8/SPI0_SS/LPUART1_TX/TPM0_CH3/I2S0_MCLK, label: 'J1[7]/I2S_MCLK/LCD_P24', identifier: LCD_P24;I2S0_MCLK}
- {pin_num: '43', pin_signal: LCD_P20/ADC0_SE14/PTC0/EXTRG_IN/USB_SOF_OUT/CMP0_OUT/I2S0_TXD0, label: 'J1[5]/I2S_TXD/LCD_P20', identifier: LCD_P20;USB_SOF_OUT}
- {pin_num: '42', pin_signal: LCD_P15/PTB19/TPM2_CH1/I2S0_TX_FS, label: 'J1[3]/I2S_TX_FS/LCD_P15', identifier: LCD_P15}
- {pin_num: '41', pin_signal: LCD_P14/PTB18/TPM2_CH0/I2S0_TX_BCLK, label: 'J1[1]/I2S_TX_BCLK/LCD_P14', identifier: LCD_P14}
...
- {pin_num: '22', pin_signal: PTA0/TPM0_CH5/SWD_CLK, label: 'J11[4]/SWD_CLK_TGTMCU'}
...
- {pin_num: '34', pin_signal: PTA20/RESET_b, label: 'J11[10]/J3[6]/RESET'}
- {pin_num: '46', pin_signal: LCD_P23/PTC3/LLWU_P7/SPI1_SCK/LPUART1_RX/TPM0_CH2/CLKOUT/I2S0_TX_BCLK, label: SW3/LLWU_P7/LCD_P23, identifier: SW3}
...
- {pin_num: '21', pin_signal: PTE25/TPM0_CH1/I2C0_SDA, label: 'U2[6]/U10[6]/I2C0_SDA', identifier: I2C1_SDA}
- {pin_num: '20', pin_signal: PTE24/TPM0_CH0/I2C0_SCL, label: 'U2[7]/U10[4]/I2C0_SCL', identifier: I2C0_SCL}
- {pin_num: '3', pin_signal: VDD17, label: P3V3_KL43Z}
- {pin_num: '13', pin_signal: VDDA, label: P3V3_KL43Z}
- {pin_num: '30', pin_signal: VDD94, label: P3V3_KL43Z}
...
- {pin_num: '51', pin_signal: VCAP2/LCD_P6/PTC22, label: LCD_P39}
- {pin_num: '52', pin_signal: VCAP1/LCD_P39/PTC23, label: LCD_P6}
- {pin_num: '57', pin_signal: LCD_P40/PTD0/SPI0_SS/TPM0_CH0/FXIO0_D0, label: LCD_P40, identifier: LCD_P40}
...
void BOARD_InitUSBPins(void)
{
    ...
    PORT_SetPinMux(BOARD_I2S0_TX_BCLK_PORT, BOARD_I2S0_TX_BCLK_PIN, kPORT_MuxAlt2);
